...
import { disposeObject, loadGltf, normalizeProp } from './assets.js';
import { ambient, box, camera, fill, floor, grid, hemi, makeMat, renderer, scene, sun, walls } from './scene.js';
import {
  FIRE_REVEAL_MS,
  MAP_HALF,
  PALETTE,
