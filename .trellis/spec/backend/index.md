...
The backend is a small Node.js/CommonJS HTTP and WebSocket service implemented in `server.js`.

| Guide | Scope |
|---|---|
| [Directory Structure](./directory-structure.md) | Current single-file organization and naming |
